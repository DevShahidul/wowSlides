...
app.controller("recentCourseList", function($scope) {
    $scope.todayCourses = [
        { "name":"WCM - İş Güvenliği 7 Adım Yaklaşımı", "hour":"10.00",  "trainer":"Işıl Taysever", "className":"D2", "targetGroup":"TOFAS" },
        { "name":"Etkili Sunum Teknikleri", "hour":"12.00",  "trainer":"Selim Aladağ", "className":"D1", "targetGroup":"TOFAS" },
